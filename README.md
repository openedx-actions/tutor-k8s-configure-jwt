...
[![Tests](https://github.com/openedx-actions/tutor-k8s-configure-jwt/actions/workflows/testRelease.yml/badge.svg)](https://github.com/openedx-actions/tutor-k8s-configure-jwt/actions)
...
# tutor-k8s-configure-jwt

Github Action to configure a javascript web token (jwt) for use in Open edX applications
